...
const Justin = new Person("Justin", 25);
console.log(Justin);
Justin.eat("Rice");
console.log(Justin.stomach);
console.log(Justin.toString())
/*
  TASK 2
...
console.log(Brit.grade("Justin", "Javascript"));
...
const Ryan = new Student({
  previousBackground: "Musican",
  className: "Web35",
  favSubjects: ["HTML","CSS","JS"]
});
console.log(Ryan.listSubjects());
console.log(Ryan.PRAssignment("Ryan", "JS"))
console.log(Ryan.sprintChallenge("Ryan", "CSS"))
...
console.log(Will.standUp("Justin", "webhelp"));
console.log(Will.debugsCode("Melissa", "Justin", "Javascript"));
