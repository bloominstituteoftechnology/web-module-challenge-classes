...
class Airplane {
 ...
 class Car {
   ...
   drive(distance) {
     if(distance>=0 && this.tank > 0){
       return this.odometer == this.odometer + distance &&this.tank ==  this.tank - this.milesPerGallon;
     }else if(this.tank===0){
 ...
 class Student extends Lambdasian{
   ...
   PRAssignment(subject){
     return `${th.name} has submitted a PR for ${subject}`;
   }
 ...
 class ProjectManager extends Instructor{
   ...
   standUp(slack_channel){
     return `${this.name} announces to ${channel1}, @channel standy times!`;
   }
   debagsCode(student,subject){
