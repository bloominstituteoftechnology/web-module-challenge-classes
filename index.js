...
const g35 = new Car('mustang', 15);

g35.fill(30);
console.log(g35.drive(451));
 ...
 class Student extends Lambdasian{
     ...
     PRAssignment(subject){
       return `${this.name} hes submitted a PR for ${this.subjects}`
     }
 ...
 class ProjectManager extends Instructor{
   ...
   standUp(){
     if(this.className){
      ...
      debugCode(){
     return `${this.gradClassName} debugs ${this.className}'s code on ${this.favSubjects}`
   }
 }
  /*
