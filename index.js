...
//give the person ability to poop
  poop(){
    this.stomach = [];
  }
  toString(){
...
console.log('this is pizza person', personOne.eat('pizza'));
console.log('this is the person itializing', personOne);
console.log('this is poop', personOne.poop());
