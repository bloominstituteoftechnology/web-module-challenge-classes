...
return `${studentObj.name} recieves a perfect score on ${subjectStr}`;
}
}
...
listSubjects(){
  ...
  const subject = this.favSubjects[i];
  if(this.favSubjects.length-1 === i){
...
// }
// const s = new Student(studentAttr)
//   console.log(s.listSubjects());
