...
class Person {
  ...
  //methods put into the prototype
  eat(food) {
...
*/
class Lambdasian {
  constructor(lambAttr) {
    this.name = lambAttr.name;
    this.age = lambAttr.age;
    this.location = lambAttr.location;
  }
  speak() {
...
class ProjectManager extends Instructor {
  ...
  standUp(channel) {
    return `${this.name} annonces to ${channel}, @channel standy times!`;
  }
